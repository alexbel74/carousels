...
const DEFAULT_KIE: KieSettings = { model: 'nano-banana-pro', apiKey: '' };
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div className="space-y-6">
                           ...
                           <div className="space-y-4">
                              ...
                              {settings.imageService === 'kie' && (
                              <div className="space-y-2 mt-3"><span className="text-[10px] font-bold text-slate-600 uppercase tracking-tight">KIE MODEL</span>
                                 <select value={kieSettings.model} onChange={e => setKieSettings({...kieSettings, model: e.target.value})} className="w-full bg-[#1e293b] border border-slate-700 rounded-2xl py-3.5 px-4 text-xs text-white outline-none focus:ring-2 focus:ring-blue-500 transition-all">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <section className="bg-[#111827] border border-slate-800 rounded-[32px] p-8 space-y-6 flex flex-col shadow-xl">
                     ...
                     <div className="mt-6 pt-6 border-t border-slate-800">
                         ...
                         <div className="space-y-1 mt-3"><label className="text-[9px] font-bold text-slate-600 uppercase">KIE MODEL</label>
                           <select value={kieSettings.model} onChange={e => setKieSettings({...kieSettings, model: e.target.value})} className="w-full bg-[#1e293b] border border-slate-700 rounded-xl py-3 px-4 text-xs text-white">
                             <option value="nano-banana-pro">Nano Banana Pro</option>
                             <option value="nano-banana-2">Nano Banana 2</option>
                           </select>
                         </div>
